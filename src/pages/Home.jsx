    ...
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* ALL BLACK IN BLACK */}
          <Link to="/products" className="group no-underline scroll-reveal fade-left">
            <div className="overflow-hidden rounded-lg shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <div className="bg-white p-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed group-hover:text-gray-900 transition-colors duration-300">
                  Mặc dù được ứng dụng rất nhiều, nhưng sắc đen lúc nào cũng toát lên một vẻ huyền bí đầy khó nhằn
                </p>
              </div>
            </div>
          </Link>
          ...
          {/* OUTLET SALE */}
          <Link to="/products?featured=sale" className="group no-underline scroll-reveal fade-right delay-200">
            <div className="overflow-hidden rounded-lg  hover:shadow-2xl transition-shadow">
              <div className="relative h-[280px] overflow-hidden bg-black">
                {/* SALE Badge */}
